...
def main(args):
    # Create the model.
    print('\n==> Creating the model...')
    model = FixationNet(args.gazeSeqSize, args.headSeqSize, args.taskSeqSize, args.saliencySize, args.clusterPath)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--inputSize', default=1792, type=int,
                        help='the number of input features (default: 1792)')    
    ...
    parser.add_argument('--taskSeqSize', default=480, type=int,
                        help='the size of task sequence data (default: 480)')        
    ...
    parser.add_argument('--clusterPath', default='/data2/hzmData/Dataset/dataset/FixationNet_150_User1/clusterCenters.npy', type=str,
                        help='the path of the cluster centers file')
    # the directory that saves the dataset.
    parser.add_argument('-d', '--datasetDir', default = '/data2/hzmData/Dataset/dataset/FixationNet_150_User1/', type = str, 
    ...
    parser.add_argument('-c', '--checkpoint', default = '../checkpoint/FixationNet_150_User1/', type = str, 
    ...
    parser.add_argument('-p', '--prdDir', default = '../predictions/FixationNet_150_User1/', type = str, 
    ...
    parser.add_argument('--gamma', type=float, default=0.8,
                        help='Used to decay learning rate (default: 0.8)')
    # the loss function.
